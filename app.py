...
with st.container():
    ...
    with st.form("project_query_form"):
        address = st.text_input("Enter Property Address", placeholder="e.g., 123 Main St, Austin, TX 78701")
        project_type = st.selectbox(
            "Select Project Type", 
            ["Fence Installation", "Deck / Patio Addition", "ADU (Accessory Dwelling Unit)", "Interior Remodel", "Roof Replacement"]
        )
